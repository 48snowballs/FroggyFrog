...
public class Game {
    ...
    public void restart(String cmd, List<Render> memory) {
        ...
        System.out.println("0x = " + pipes.get(0).x);
        System.out.println("0y = " + pipes.get(0).y);
        System.out.println("1x = " + pipes.get(1).x);
        System.out.println("1y = " + pipes.get(1).y);
        System.out.println("2x = " + pipes.get(2).x);
        System.out.println("2y = " + pipes.get(2).y);
        System.out.println("3x = " + pipes.get(3).x);
        System.out.println("3y = " + pipes.get(3).y);
